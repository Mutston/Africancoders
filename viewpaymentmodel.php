...
$no=$no+1;
	...
	echo"
	 ...
	 <td><a href='updatepaymentmodel.php?id=$PAYMENTMODEL_id'  class='btn btn-primary' pymdid='$PAYMENTMODEL_id'><span class='glyphicon glyphicon-ok-sign'>Edit</span></a></td>
	  </tr>
	 ";
	  }}else{
			echo"<tr>
