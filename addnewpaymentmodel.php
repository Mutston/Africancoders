...
$sql="INSERT INTO `paymentmodel_tb`(`PAYMENTMODEL_name`, `PAYMENTMODEL_amount`)VALUES('$paymodel','$opbalance')";
...
<div class="container-fluid mt-3">
  <div class="row">
    ...
    <div class="col-sm-6">
  <form action="addnewpaymentmodel.php" method="POST">
    <div class="mb-3 mt-3">
      <label for="email">PAYMENT METHOD</label>
      <input type="text" class="form-control" id="paymodel" placeholder="Enter Name" name="paymodel" required>
    </div>
    <div class="mb-3">
      <label for="pwd">OPENING BALANCE</label>
      <input type="text" class="form-control" id="popbalance" placeholder="Enter balance" name="opbalance" required>
    </div>
