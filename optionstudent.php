...
<div class='table-responsive'>          
  <table class='table'>
    ...
    <tbody>";
	$sql="SELECT count(*) as totstudent,`option_id`, `option_name`, `option_faculte`,`faculte_id`, `faculte_name` FROM `student_tb` INNER JOIN `option_tb` ON `student_option`=`option_id` INNER JOIN `faculte_tb` ON `option_faculte`=`faculte_id` group by `option_id`";
