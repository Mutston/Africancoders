...
$no=$no+1;
	...
	echo"
	 ...
	 <td><a href='studentupdatemyinfo.php?id=$student_id'  class='btn btn-primary' ><span class='glyphicon glyphicon-ok-sign'>Update</span></a></td>
	  </tr>
	 ";
	  }}else{
			echo"<tr>
