...
<div class='table-responsive'>          
  <table class='table'>
    <thead>
	    <tr>
      <th colspan='6'>  
	     <form action='addemployeemenu.php' method='POST'>
    <div class='mb-3 mt-3'>
       <input type='text' class='form-control' placeholder='Enter EMPLOYEE NAME' name='employeecode'>  </th>
  <th><button type='submit' name='searchemployee' class='btn btn-primary'>Save</button>  </div>
  </form><th>
...
$no=$no+1;
	...
	echo"
	 ...
	 <td><a href='viewemployeeaddmenu.php?id=$EMPLOYEE_id'  class='btn btn-primary' ><span class='glyphicon glyphicon-ok-sign'>View</span></a></td>
	  </tr>
	 ";
	  }}else{
			echo"<tr>
